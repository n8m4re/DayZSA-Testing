...
_vars = [["unconscious",true],["modifiers",[]],["modstates",[]],["myNotifiers",[]],["damageArray",[]],["exposure",0],["bloodtype","BloodONeg"],["blood",0],["health",0],["shock",0],["feet",0],["energy",0],["water",0],["stomach",0],["restrainedwith",0],["bodytemperature",0],["heatcomfort",0],["diet",0],["bleedingsources","[]"],["wet",0],["musclecramp",0],["penalties",0],["totalWeight",0],["totalHeatIsolation",0],["bleedingLevel",0],["underwater",0]];
_char = [false,"",[0,0,0]];
_quickbar = ["","","","","","","","",""];
_state = [];
_items = []; 
