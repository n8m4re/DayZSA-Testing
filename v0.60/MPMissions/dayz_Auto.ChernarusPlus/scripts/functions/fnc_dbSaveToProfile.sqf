private ["_char","_agent","_uid","_vars","_state","_items","_itemInHands"];
_uid = _this select 0;
_agent = _this select 1;
if (isNull _agent) exitWith {true};

_vars = [
["exposure",0],["modifiers",[]],["modstates",[]],["bloodtype","BloodONeg"],["blood",0],["health",0],
["shock",0],["feet",0],["energy",0],["water",0],["stomach",0],["restrainedwith",0],["bodytemperature",0],
["heatcomfort",0],["diet",0],["kzombies",0],["kplayers",0],["bleedingsources","[]"],["unconscious",true],["myNotifiers",[]],
["damageArray",[]],["wet",0],["musclecramp",0],["penalties",0],["totalWeight",0],
["totalHeatIsolation",0],["bleedingLevel",0],["underwater",0],["falldamage",false]
];
...
// Player state vars
{(_state select 0) set [(count(_state select 0)),[(_x select 0),(_agent getVariable [(_x select 0),(_x select 1)])]]} count _vars;
